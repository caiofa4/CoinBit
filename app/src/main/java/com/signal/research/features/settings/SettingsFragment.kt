...
class SettingsFragment : Fragment(), SettingsContract.View {
    ...
    private fun initializeUI(inflatedView: View) {
        ...
        val currency = PreferencesManager.getPreference(requireContext(), PreferencesManager.DEFAULT_CURRENCY, defaultCurrency)
        ...
        inflatedView.clRate.setOnClickListener {
            rateSignal(requireContext())
        }

        inflatedView.clShare.setOnClickListener {
            shareSignal(requireContext())
        }
    ...
    private fun openCurrencyPicker() {
        ...
        picker.setListener { name, code, _, _ ->
            ...
            PreferencesManager.setPreference(requireContext(), PreferencesManager.DEFAULT_CURRENCY, code)
